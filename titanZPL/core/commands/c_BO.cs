...
namespace titanZPL.commands  {
    public class zpl_cmd_c_BO : zpl_command{   //Aztec Bar Code Parameters
        ...
        public zpl_cmd_c_BO(string data,List<zpl_command> commands):base(commands){                    
            cmd        ="^BO";                   
...
g =_ID_field // //no ID  ZPL Commands ^BO 100 P1012728-011 Zebra Programming Guide 11/21/1
